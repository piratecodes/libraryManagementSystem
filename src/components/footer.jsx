    ...
    return(
        <footer className="p-4 bg-white md:p-8 lg:p-10 dark:bg-gray-800">
            <div className="mx-auto max-w-screen-xl text-center">
                ...
                <p className="my-6 text-gray-500 dark:text-gray-400">If you’re ready to turn the page, you can do it here. Literally.</p>
                ...
                <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2021-2022 <Link href="/" className="hover:underline">Library Management™</Link>. All Rights Reserved.</span>
            </div>
        </footer>
    )
}
